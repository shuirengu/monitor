...
{name:'十堰', areaList:['市辖区','茅箭区','张湾区','郧县','郧西县','竹山县','竹溪县','房县']},		   
{name:'宜昌', areaList:['市辖区','西陵区','伍家岗区','点军区','猇亭区','夷陵区','远安县','兴山县','秭归县','长阳土家族自治县','五峰土家族自治县','宜都市','当阳市','枝江市']},		   
{name:'襄阳', areaList:['市辖区','襄城区','樊城区','襄阳区','南漳县','谷城县','保康县','老河口市','宜城市']},		   
{name:'鄂州', areaList:['市辖区','梁子湖区','华容区','鄂城区']},		   
{name:'荆门', areaList:['市辖区','东宝区','掇刀区','京山县','沙洋县','钟祥市']},		   
{name:'孝感', areaList:['市辖区','孝南区','孝昌县','大悟县','云梦县']},		   
{name:'荆州', areaList:['市辖区','沙市区','荆州区','公安县','监利县','江陵县','石首市','松滋市','洪湖市']},		   
{name:'黄冈', areaList:['市辖区','黄州区','团风县','红安县','罗田县','英山县','浠水县','蕲春县','黄梅县','麻城市','武穴市']},		   
{name:'咸宁', areaList:['市辖区','咸安区','嘉鱼县','通城县','崇阳县','通山县']},		   
{name:'随州', areaList:['市辖区','曾都区']},	
{name:'安陆', areaList:['市辖区']},
{name:'潜江', areaList:['市辖区']},
{name:'天门', areaList:['市辖区']},
{name:'仙桃', areaList:['市辖区']},
{name:'枣阳', areaList:['市辖区']},
{name:'赤壁', areaList:['市辖区']},
{name:'广水', areaList:['市辖区']},
{name:'汉川', areaList:['市辖区']},
{name:'应城', areaList:['市辖区']},
{name:'神龙架', areaList:['市辖区']},
{name:'丹江口', areaList:['市辖区']},
